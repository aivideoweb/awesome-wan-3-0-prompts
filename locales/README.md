...
Every localized README links to VideoWeb AI's Wan 3.0 browser page and affiliate program. The shared [English browser workflow guide](../guides/videoweb-workflow.md) and [Chinese guide](../guides/videoweb-workflow.zh-CN.md) explain how to choose inputs, adapt unsupported controls and evaluate a first result. Current prices and available settings must be checked in the generator. The main prompt files are Chinese and English; the 15 entry guides are not 15 complete translations of the catalog.

| Language | Localized guide | Language code |
|---|---|---|
| English | [README](../README.md) | `en` |
| 简体中文 | [README](../README.zh-CN.md) | `zh-CN` |
| 繁體中文 | [README](../README.zh-TW.md) | `zh-TW` |
| 日本語 | [README](../README.ja.md) | `ja` |
| 한국어 | [README](../README.ko.md) | `ko` |
| Español | [README](../README.es.md) | `es` |
| Français | [README](../README.fr.md) | `fr` |
| Deutsch | [README](../README.de.md) | `de` |
| Português do Brasil | [README](../README.pt-BR.md) | `pt-BR` |
| Italiano | [README](../README.it.md) | `it` |
| العربية | [README](../README.ar.md) | `ar` |
| Русский | [README](../README.ru.md) | `ru` |
| Bahasa Indonesia | [README](../README.id.md) | `id` |
| ไทย | [README](../README.th.md) | `th` |
| Tiếng Việt | [README](../README.vi.md) | `vi` |

## Localization rules

1. Translate intent and production meaning, not word order.
2. Keep one primary language for the visual brief.
3. Preserve exact dialogue in the spoken language and name the locale or accent only when relevant.
4. Keep camera quantities, timecodes, aspect ratios, reference IDs, and continuity locks unchanged.
