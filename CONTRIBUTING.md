...
Thank you for helping make this a practical, testable, multilingual Wan 3.0 prompt library. You can contribute through the [guided prompt form](https://github.com/aivideoweb/awesome-wan-3-0-prompts/issues/new?template=prompt.yml) or a pull request. A [Simplified Chinese guide](CONTRIBUTING.zh-CN.md) is also available.

## Good contributions

Have an external X example rather than your own tested prompt? Use the [source suggestion form](https://github.com/aivideoweb/awesome-wan-3-0-prompts/issues/new?template=source.yml). Linking a creator's work does not grant permission to copy or relicense it. For repository edits, follow the [maintenance checks](MAINTAINING.md).
...
Use the [prompt submission form](https://github.com/aivideoweb/awesome-wan-3-0-prompts/issues/new?template=prompt.yml). Please submit one prompt per issue and include:

1. A unique, searchable title and short practical use case.
2. The tested workflow: T2V, I2V, start/end frames, R2V, or video edit.
...
**Mode:** T2V · **Suggested:** 10 seconds, 16:9

```text
Complete copy-ready directing brief.
```
````
...
- Do not retain someone else’s watermark, tracking link, author handle, affiliate copy, or promotional language.
...
- A new language entry should include a localized prompt formula and one complete copy-ready prompt.
